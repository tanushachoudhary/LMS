...
export const dummyTestimonial = [
  {
    ...
    rating: 5,
    feedback:
      "Edemy completely changed my career path. The interactive courses and hands-on projects helped me land my dream job as a software developer!",
  },
  {
    name: "Richard Nelson",
    role: "SWE 2 @ Samsung",
    ...
    rating: 4,
    feedback:
      "The instructors are top-notch, and the course structure is easy to follow. The quizzes and real-world assignments kept me engaged throughout!",
  },
  {
    ...
    rating: 4.5,
    feedback:
      "I was hesitant about online learning, but Edemy proved me wrong. The courses are well-structured, and the flexibility allowed me to learn at my own pace.",
  },
];
